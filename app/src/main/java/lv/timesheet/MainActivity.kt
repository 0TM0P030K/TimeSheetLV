    ...
    Dialog(onDismissRequest={show=false}){
     Card(Modifier.fillMaxWidth().padding(16.dp)){
      Column(Modifier.padding(16.dp).verticalScroll(rememberScrollState())){
       ...
       Text("Likme "+String.format("%.2f",base))
       Text("VirsSt "+String.format("%.2f",vP))
       Text("NaktsSt "+String.format("%.2f",nP))
       Text("Pr.Norma "+String.format("%.2f",pN))
       Text("Pr.Virsst "+String.format("%.2f",pV))
